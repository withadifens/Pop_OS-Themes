# Generated by Powerlevel10k configuration wizard on 2021-05-12 at 14:38 WIB.
...
# 12h time, round separators, slanted heads, flat tails, 2 lines, dotted, right frame,
...
() {
  ...
  #################################[ user: username ]##################################
    ...
    typeset -g POWERLEVEL9K_USER_BACKGROUND=23
  ...
  typeset -g POWERLEVEL9K_DIR_ANCHOR_FOREGROUND=23
